...
val grammarList = listOf(
    ...
    Grammar(
        "Giá mà tôi có tiền thì tôi mua sách.",
        "もしお金があれば本を買うのに",
        "接続詞",
        "Giá mà A thì B",
        "もしAならBなのに"
    ...
    Grammar(
        "Giá mà anh ấy ở đây thì tôi vui hơn.",
        "もし彼がここにいればもっと嬉しいのに",
        "接続詞",
        "Giá mà A thì B",
        "もしAならBなのに"
    ...
    Grammar(
        "Giá mà tôi rảnh thì tôi giúp bạn.",
        "もし暇ならあなたを手伝うのに",
        "接続詞",
        "Giá mà A thì B",
        "もしAならBなのに"
    ...
    Grammar(
        "Giả sử trời mưa thì chúng tôi ở nhà.",
        "もし仮に雨が降ったら、私たちは家にいます",
        "接続詞",
        "Giả sử A thì B",
        "もし仮にAならB"
    ),
    Grammar(
        "Giả sử bạn đến sớm thì chúng ta bắt đầu ngay.",
        "もしあなたが早く来たら、すぐ始めます",
        "接続詞",
        "Giả sử A thì B",
        "もし仮にAならB"
    ...
    Grammar(
        "Giả sử tôi khỏe hơn thì tôi làm tiếp.",
        "もし私がもっと元気なら、続けます",
        "接続詞",
        "Giả sử A thì B",
        "もし仮にAならB"
